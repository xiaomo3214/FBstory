...
function mousePeanut(){
  ...
  window.addEventListener('mouseup',function(event){
    // event.preventDefault();
    if(droppeanut == 1) peanut1.css("display","none");
    if(droppeanut == 2) peanut2.css("display","none");
    if(droppeanut == 3) peanut3.css("display","none");
    if(droppeanut == 4) peanut4.css("display","none");
    if(droppeanut == 5) peanut5.css("display","none");
    if(droppeanut == 6) peanut6.css("display","none");
    if(droppeanut == 7) peanut7.css("display","none");
    if(droppeanut == 8) peanut8.css("display","none");
    mouse1 = false;
